...
class Gobang():
    ...
    def createWidgets(self):
        ...
        # self.bg_image = tkinter.PhotoImage(file='fig/chimp.png')
    ...
    def place(self, x, y, color):
        ...
        if self.player == PLAYER2:
            label = tk.Label(app, text = "プレイヤー1の番です", font = (" ", "20", "bold"))
            label.pack()
            self.player = PLAYER1
        else:
            label = tk.Label(app, text = "プレイヤー2の番です", font = (" ", "20", "bold"))
            label.pack()
            self.player = PLAYER2
    ...
    def showResult(self):
        ...
        winner = self.player
        if winner == PLAYER1:
            tkinter.messagebox.showinfo('結果', 'プレイヤー1の勝ち')
        else:
            tkinter.messagebox.showinfo('結果', 'プレイヤー2の勝ち')
